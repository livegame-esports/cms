...
$access['delete_files']       = false;
$access['create_folders']     = false;
$access['delete_folders']     = false;
$access['upload_files']       = true;
$access['rename_files']       = false;
$access['rename_folders']     = false;
$access['duplicate_files']    = false;
$access['copy_cut_files']     = false;
$access['copy_cut_dirs']      = false;
$access['chmod_files']        = false;
$access['chmod_dirs']         = false;
$access['preview_text_files'] = false;
$access['edit_text_files']    = false;
$access['create_text_files']  = false;

if(is_admin()) {
	$access['delete_files']       = true;
	$access['create_folders']     = true;
	$access['delete_folders']     = true;
	$access['upload_files']       = true;
	$access['rename_files']       = true;
	$access['rename_folders']     = true;
	$access['duplicate_files']    = true;
	$access['copy_cut_files']     = true;
	$access['copy_cut_dirs']      = true;
	$access['preview_text_files'] = true;
	$access['create_text_files']  = true;
}

if(isset($is_admin)) {
	if(is_admin() && $is_admin == 'admin') {
		$_SESSION['user_path'] = 'admin';
	} else {
		$_SESSION['user_path'] = $_SESSION['id'];
	}
}
$user_path = $_SESSION['user_path'];

if(!file_exists(
	$_SERVER["DOCUMENT_ROOT"] . '/files/filemanager/' . $user_path . '/'
)) {
	mkdir(
		$_SERVER["DOCUMENT_ROOT"] . '/files/filemanager/' . $user_path . '/',
		0777
...
if(!file_exists(
	$_SERVER["DOCUMENT_ROOT"] . '/files/thumbs/' . $user_path . '/'
)) {
	mkdir(
		$_SERVER["DOCUMENT_ROOT"] . '/files/thumbs/' . $user_path . '/',
		0777
...
if($settings['file_manager'] == 1) {
	$settings['file_manager'] = true;
} else {
	$settings['file_manager'] = false;
}
...
$extGroups = [
	'ext_img' => $settings['ext_img'],
	'ext_file' => $settings['ext_file'],
	'ext_video' => $settings['ext_video'],
	'ext_music' => $settings['ext_music'],
	'ext_misc' => $settings['ext_misc']
];
...
$config = [
	...
	*/
	...
	|
	*/
	'upload_dir'                       => 'files/filemanager/' . $user_path . '/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path'                     => '../../../../files/filemanager/' . $user_path . '/',
	...
	|
	*/
	'thumbs_base_path'                 => '../../../../files/thumbs/' . $user_path . '/',
	...
	*/
	...
	|
	*/
	'MaxSizeUpload'                  => $settings['file_max_size'],
	...
	*/
	...
	//******************
	'delete_files'                   => $access['delete_files'],
	'create_folders'                 => $access['create_folders'],
	'delete_folders'                 => $access['delete_folders'],
	'upload_files'                   => $access['upload_files'],
	'rename_files'                   => $access['rename_files'],
	'rename_folders'                 => $access['rename_folders'],
	'duplicate_files'                => $access['duplicate_files'],
	'extract_files'                  => false,
	'copy_cut_files'                 => $access['copy_cut_files'],
	// for copy/cut files
	'copy_cut_dirs'                  => $access['copy_cut_dirs'],
	// for copy/cut directories
	'chmod_files'                    => $access['chmod_files'],
	// change file permissions
	'chmod_dirs'                     => $access['chmod_dirs'],
	// change folder permissions
	'preview_text_files'             => $access['preview_text_files'],
	// eg.: txt, log etc.
	'edit_text_files'                => $access['edit_text_files'],
	// eg.: txt, log etc.
	'create_text_files'              => $access['create_text_files'],
	...
	//**********************
	'ext_img'                        => explode(" ", $settings['ext_img']),
	//Images
	'ext_file'                       => explode(" ", $settings['ext_file']),
	//Files
	'ext_video'                      => explode(" ", $settings['ext_video']),
	//Video
	'ext_music'                      => explode(" ", $settings['ext_music']),
	//Audio
	'ext_misc'                       => explode(" ", $settings['ext_misc']),
	//Archives
