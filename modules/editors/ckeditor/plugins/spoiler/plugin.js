CKEDITOR.plugins.add( 'spoiler' , {
	...
	init: function( editor ) {
		...
		function createSpoiler() {
			...
			var spoilerTitleText = editor.document.createElement( 'div', { 'attributes' : { 'class': 'title-text' } } );
			...
			spoilerTitle.append( spoilerTitleText );
			spoilerTitleText.appendHtml( 'Спойлер' );
