						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-2 col-6">
									...
									<ul>
										<?php for($i=0; $i < count($vertical_menu_2); $i++): ?> <li>
								...
								<div class="col-lg-2 col-6">
									...
									<ul>
										<?php for($i=0; $i < count($vertical_menu_3); $i++): ?> <li>
								...
								<div class="col-lg-3">
									...
									<ul>
										<?php for($i=0; $i < count($vertical_menu_4); $i++): ?> <li>
								...
								<div class="col-lg-4 banners">
									<?php for($i=0; $i < count($footer_banners); $i++): ?> <a href="<?php echo $footer_banners[$i]['link']; ?>" target="_blank">
