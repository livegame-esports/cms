	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="block" id="vk_area">
				...
				{else}
					{if($user->vk_api == '0')}
						...
						<a class="btn btn-outline-primary" id="vk_attach_link" href="#">Прикрепить профиль к VK</a><br>
					{else}
						<div class="noty-block info">
			...
			<div class="block" id="steam_area">
				...
				<a class="btn btn-outline-primary" id="steam_attach_link" href="#">Прикрепить профиль к Steam</a><br>
				{else}
				<div class="noty-block info">
			...
			<div class="block" id="fb_area">
				...
				{if($auth_api->fb_api == '1')}
					{if($user->fb_api == '0')}
						...
						<a class="btn btn-outline-primary" id="fb_attach_link" href="#">Прикрепить профиль к Facebook</a><br>
					{else}
						<div class="noty-block info">
