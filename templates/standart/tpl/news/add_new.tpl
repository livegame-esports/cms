<div class="col-lg-9 order-is-first">
	<div class="block">
		...
		<div class="form-group">
			...
			<div class="row">
				<div class="col-lg-3">
					<img id="img" src="../files/news_imgs/none.jpg" class="w-100">
				</div>
				<div class="col-lg-9">
					<div class="input-group">
						<form enctype="multipart/form-data" id="add_img_form">
							...
							<input type="file" id="new_img" accept="image/*" name="new_img"/><br>
		...
		<div class="form-group">
			...
			<textarea id="short_text" class="form-control" rows="3" maxlength="250"></textarea>
		</div>
		...
		<div class="smile_input_forum">
			<button id="create_btn" onclick="add_new();" type="button" class="btn btn-primary">Создать</button>
