...
// 1 - таблицей
// 2 - большой таблицей
{var:monitoringType} 0 {/var}


// Количество отображаемых серверов для табличного мониторинга
// -----------------
// 0 - все
{var:countOfServersDisplayed} 3 {/var}
...
//Жалобы
{var:vertical_menu[6]['name']} Жалобы {/var}
{var:vertical_menu[6]['link']} ../complaints/ {/var}
...
// ------------------------
//banner 1
{var:footer_banners[0]['link']} https://gamecms.ru/ {/var}
{var:footer_banners[0]['img']} https://via.placeholder.com/88x31.jpg {/var}
//banner 2
{var:footer_banners[1]['link']} https://gamecms.ru/ {/var}
{var:footer_banners[1]['img']} https://via.placeholder.com/88x31.jpg {/var}
//banner 3
{var:footer_banners[2]['link']} https://gamecms.ru/ {/var}
{var:footer_banners[2]['img']} https://via.placeholder.com/88x31.jpg {/var}
