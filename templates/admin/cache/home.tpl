	...
	<div class="col-md-6">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body mb-0">
				...
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default <?php if($conf->standard_registration): ?> active <?php endif; ?>" onclick="change_value('config','standard_registration','1','1');">
						<input type="radio">
						Включить
					</label>

					<label class="btn btn-default <?php if(!$conf->standard_registration): ?> active <?php endif; ?>" onclick="change_value('config','standard_registration','0','1');">
						<input type="radio">
						Выключить
					</label>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-default <?php if('{auto_steam_id_fill}' == '1'): ?> active <?php endif; ?>" onclick="change_value('config__secondary','auto_steam_id_fill','1','1');">
								<input type="radio">
								Включить
							</label>

							<label class="btn btn-default <?php if('{auto_steam_id_fill}' == '2'): ?> active <?php endif; ?>" onclick="change_value('config__secondary','auto_steam_id_fill','2','1');">
								<input type="radio">
								Выключить
							</label>
						</div>
					...
					<div class="col-md-4">
						...
						<select class="form-control" onchange="change_value('config__secondary','steam_id_format',$(this).val(),'1');">
							<option value="0" <?php if('{steam_id_format}' == '0'): ?> selected <?php endif; ?>>
								STEAM_0:X:XXXXXX (cs1.6)
							</option>
							<option value="1" <?php if('{steam_id_format}' == '1'): ?> selected <?php endif; ?>>
			...
			<div class="panel-body">
				...
				<div class="input-group mt-10">
					...
					<select id="top_donators_show_sum" class="form-control">
						<option value="1" <?php if('{top_donators_show_sum}' == '1'): ?> selected <?php endif; ?>>Отображать сумму доната</option>
						<option value="2" <?php if('{top_donators_show_sum}' == '2'): ?> selected <?php endif; ?>>Не отображать сумму доната</option>
					</select>
			...
			<div class="panel-body">
				<div class="input-group">
					...
					<select id="protocol" class="form-control">
						<option value="1" <?php if('{protocol}' == '1'): ?> selected <?php endif; ?>>Определять автоматически</option>
						<option value="2" <?php if('{protocol}' == '2'): ?> selected <?php endif; ?>>HTTP</option>
						<option value="3" <?php if('{protocol}' == '3'): ?> selected <?php endif; ?>>HTTPS</option>
					</select>
				</div>
			</div>
		</div>
