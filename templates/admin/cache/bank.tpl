	...
	<div class="row">
		<div class="col-md-12">
			<div class="block">
				...
				<a class="td-u c-p" title="Подробнее" onclick="load_bank_info('1');">{bank1}</a>
				 <?php echo $messages['RUB']; ?>, за данный месяц:
		...
		<div class="col-md-6">
			...
			<div class="block">
				...
				<div class="col-md-2">
					<button class="btn btn-default" data-target="#bonuses" data-toggle="modal" onclick="load_bonuses();">Настройка</button>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<div class="btn-group" data-toggle="buttons">
	...
	<div class="modal-dialog modal-lg2">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Статистика за все время ({bank1}<?php echo $messages['RUB']; ?>)</h4>
			</div>
...
<div id="bank2" class="modal fade">
	<div class="modal-dialog modal-lg2">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Статистика за данный месяц ({bank2}<?php echo $messages['RUB']; ?>)</h4>
			</div>
			<div class="modal-body">
...
<div id="bank3" class="modal fade">
	<div class="modal-dialog modal-lg2">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Статистика за прошлый месяц ({bank3}<?php echo $messages['RUB']; ?>)</h4>
			</div>
			<div class="modal-body">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="bs-callout bs-callout-info mb-10 fs-14">
					Данная функция позволяет пользователям получать бонусы при пополнении счета. К примеру, при настройках с диапазоном от 100 до 500<?php echo $messages['RUB']; ?> и бонусом в 25<?php echo $messages['RUB']; ?>, пользователь, при пополнеии счета на 200<?php echo $messages['RUB']; ?> получит дополнительно 25<?php echo $messages['RUB']; ?> как бонус. Второй пример: диапазон от 100 до 300<?php echo $messages['RUB']; ?>, бонус в 5%, при пополнении счета на 200<?php echo $messages['RUB']; ?> пользователь получит 5% от 200 как бонус - 10<?php echo $messages['RUB']; ?>
				</div>
