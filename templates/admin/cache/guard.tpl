<div class="page">
	<div class="col-md-6">
		<div class="block">
			...
			<div class="form-group">
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default <?php if($conf->ip_protect == 1): ?> active <?php endif; ?>" onclick="edit_ip_protect('1');">
						<input type="radio">
						Включить
					</label>

					<label class="btn btn-default <?php if($conf->ip_protect == 2): ?> active <?php endif; ?>" onclick="edit_ip_protect('2');">
						<input type="radio">
						Выключить
					</label>
				</div>
			...
			<div class="form-group">
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default <?php if($conf->token == 1): ?> active <?php endif; ?>" onclick="change_value('config','token','1','1');">
						<input type="radio">
						Включить
					</label>

					<label class="btn btn-default <?php if($conf->token == 2): ?> active <?php endif; ?>" onclick="change_value('config','token','2','1');">
						<input type="radio">
						Выключить
					</label>
				</div>
			...
			<div class="form-group">
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default <?php if($conf->global_ban == 1): ?> active <?php endif; ?>" onclick="change_value('config','global_ban','1','1');">
						<input type="radio">
						Включить
					</label>

					<label class="btn btn-default <?php if($conf->global_ban == 2): ?> active <?php endif; ?>" onclick="change_value('config','global_ban','2','1');">
						<input type="radio">
						Выключить
					</label>
				</div>
		...
		<div class="block">
			...
			<div class="btn-group" data-toggle="buttons">
				<label class="btn btn-default <?php if($conf->captcha == 1): ?> active <?php endif; ?>" onclick="onCaptcha();">
					<input type="radio">
					Включить
				</label>

				<label class="btn btn-default <?php if($conf->captcha == 2): ?> active <?php endif; ?>" onclick="offCaptcha();">
					<input type="radio">
					Выключить
				</label>
			</div>
			<div class="input-group mt-10">
				...
				<input value="<?php echo $conf->captcha_client_key; ?>" type="text" class="form-control" id="captcha_client_key" maxlength="256" autocomplete="off" placeholder="Клиентский ключ">
				<input value="<?php echo $conf->captcha_secret; ?>" type="text" class="form-control" id="captcha_secret" maxlength="256" autocomplete="off" placeholder="Секретный ключ">
			</div>
	...
	<div class="col-md-6">
		<div class="block">
			...
			<div class="form-group mb-0">
				<div class="input-group">
					...
					<input type="text" class="form-control" id="col_login" maxlength="3" autocomplete="off" value="<?php echo $configSecondary->col_login; ?>">
				</div>
		...
		<div class="block">
			...
			<div class="form-group">
				<div class="btn-group mb-10" data-toggle="buttons">
					<label class="btn btn-default <?php if($conf->protect == 1): ?> active <?php endif; ?>" onclick="edit_protect('1');">
						<input type="radio">
						Включить
					</label>

					<label class="btn btn-default <?php if($conf->protect == 2): ?> active <?php endif; ?>" onclick="edit_protect('2');">
						<input type="radio">
						Выключить
					</label>
				</div>
			...
			<div class="input-group">
				...
				<input type="number" class="form-control" id="violations_delta" maxlength="5" autocomplete="off" value="<?php echo $conf->violations_delta; ?>">
			</div>
			...
			<div class="input-group">
				...
				<input type="number" class="form-control" id="violations_number" maxlength="5" autocomplete="off" value="<?php echo $conf->violations_number; ?>">
			</div>
		...
		<div class="block">
			...
			<div class="input-group">
				...
				<select id="hidePlayersIdType" class="form-control">
					<option value="0" <?php if($conf->hide_players_id == '0'): ?> selected <?php endif; ?>>Не скрывать</option>
					<option value="1" <?php if($conf->hide_players_id == '1'): ?> selected <?php endif; ?>>Скрывать у всех</option>
					<option value="2" <?php if($conf->hide_players_id == '2'): ?> selected <?php endif; ?>>Только у админов</option>
					<option value="3" <?php if($conf->hide_players_id == '3'): ?> selected <?php endif; ?>>Только у игроков</option>
				</select>
			</div>
		...
		<div class="block">
			...
			<div class="col-md-6">
				<div class="form-group">
					<div class="btn-group" data-toggle="buttons">
						<label class="btn btn-default <?php if($configSecondary->bad_nicks_act == 1): ?> active <?php endif; ?>" onclick="change_value('config__secondary','bad_nicks_act','1','1');">
							<input type="radio">
							Включить
						</label>

						<label class="btn btn-default <?php if($configSecondary->bad_nicks_act == 2): ?> active <?php endif; ?>" onclick="change_value('config__secondary','bad_nicks_act','2','1');">
							<input type="radio">
							Выключить
						</label>
					</div>
