	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="block">
				...
				<small class="c-868686">Установка с сайта t.minibam.ru, только на php до 7.4(вкл.)</small>
			...
			<div class="block">
				...
				<ol class="tree">
					<li class="toggle">
						...
						<input type="checkbox">
						<ol class="tree">
							<li class="file" id="data9">
								<a onclick="upload_template_img('files/merchants/', 'data9');" alt="Загрузить свое изображение" class="c-p">
									Загрузить свое изображение
								</a>
							</li>
							{engine_merchants}
