	...
	<div class="col-md-6">
		<div class="block" id="add_admin_area">
			...
			<select class="form-control" id="store_type" onchange="local_change_store_type();">
				<?php if($binds[0]): ?><option value="1">Ник + пароль</option><?php endif; ?>
				<?php if($binds[1]): ?><option value="2">STEAM ID</option><?php endif; ?>
				<?php if($binds[2]): ?><option value="3">STEAM ID + пароль</option><?php endif; ?>
			</select>
