<div class="page">
	<div class="bs-callout bs-callout-info">
		<h5>Информация</h5>
		<p>
			<a target="_blank" href="https://gamecms.ru/wiki/nastroyka-pochtovogo-servera">
				<span class="glyphicon glyphicon-link"></span> Описание и инструкция по настройке
			</a>
		</p>
	</div>
	<br>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<select id="verify_peers" class="form-control mb-10">
					<option value="1" <?php if('{verify_peers}' == '1'): ?> selected <?php endif; ?>>Да</option>
					<option value="2" <?php if('{verify_peers}' == '2'): ?> selected <?php endif; ?>>Нет</option>
				</select>
			</div>
		</div>
