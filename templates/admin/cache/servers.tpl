			...
			<div class="col-md-6">
				...
				<div class="input-group">
					<span class="input-group-btn">
						<button id="btn_mon_gap" class="btn btn-default <?php if('{api_active}' == 'active'): ?> disabled <?php endif; ?>" type="button" onclick="edit_mon_gap();">Изменить</button>
					</span>
					<input <?php if('{api_active}' == 'active'): ?> disabled <?php endif; ?> type="number" class="form-control" id="mon_gap" maxlength="5" autocomplete="off" value="{mon_gap}">
				</div>
