    ...
    <div class="row">
        <div class="col-md-6">
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->fk_new == 1)} active {/if}"
                               onclick="change_value('config__bank','fk_new','1','1','fk_new_login,fk_new_pass1,fk_new_pass2');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->fk_new == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->fk == 1)} active {/if}"
                               onclick="change_value('config__bank','fk','1','1','fk_login,fk_pass1,fk_pass2');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->fk == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->rb == 1)} active {/if}"
                               onclick="change_value('config__bank','rb','1','1','rb_login,rb_pass1,rb_pass2');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->rb == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->ik == 1)} active {/if}"
                               onclick="change_value('config__bank','ik','1','1','ik_login,ik_pass1');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->ik == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->ps == 1)} active {/if}"
                               onclick="change_value('config__bank','ps','1','1','ps_num,ps_pass');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->ps == 2)} active {/if}"
                ...
                <div class="row mt-10">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="btn-group" data-toggle="buttons">
                                <label class="btn btn-default {if($merchants->ps_test == 1)} active {/if}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="btn-group" data-toggle="buttons">
                                <label class="btn btn-default {if($merchants->ps_currency == 'RUB')} active {/if}"
                                       onclick="change_value('config__bank','ps_currency','RUB','1');">
                                    <input type="radio">
                                    RUB
                                </label>

                                <label class="btn btn-default {if($merchants->ps_currency == 'USD')} active {/if}"
                                       onclick="change_value('config__bank','ps_currency','USD','1');">
                                    <input type="radio">
                                    USD
                                </label>

                                <label class="btn btn-default {if($merchants->ps_currency == 'EUR')} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons" id="liqpayTrigger">
                        <label class="btn btn-default {if($merchants->lp == 1)} active {/if}"
                               onclick="change_value('config__bank','lp','1','1');">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->lp == 2)} active {/if}"
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           ...
                           maxlength="255"
                           autocomplete="off"
                           value="{{$merchants->lp_private_key}}"
                           placeholder="Секретный ключ">
                </div>
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->payanyway == 1)} active {/if}"
                               onclick="change_value('config__bank','payanyway','1','1');">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->payanyway == 2)} active {/if}"
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           ...
                           maxlength="255"
                           autocomplete="off"
                           value="{{$merchants->payanyway_code}}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->yookassa == 1)} active {/if}"
                               onclick="change_value('config__bank','yookassa','1','1');">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->yookassa == 2)} active {/if}"
        ...
        <div class="col-md-6">
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->up == 1)} active {/if}"
                               onclick="change_value('config__bank','up','1','1','up_type,up_pass1,up_pass2');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->up == 2)} active {/if}"
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           ...
                           maxlength="255"
                           autocomplete="off"
                           value="{{$merchants->up_pass2}}"
                           placeholder="SECRET KEY">
                    <select class="form-control" id="up_type">
                        <option value="1" {if($merchants->up_type == '1')} selected {/if}>
                            Способ работы: физ. лицо
                        </option>
                        <option value="2" {if($merchants->up_type == '2')} selected {/if}>
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->wo == 1)} active {/if}"
                               onclick="change_value('config__bank','wo','1','1','wo_login,wo_pass');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->wo == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->w == 1)} active {/if}"
                               onclick="change_value('config__bank','wb','1','1','wb_login,wb_pass1,wb_num');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->w == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->ya == 1)} active {/if}"
                               onclick="change_value('config__bank','ya','1','1','ya_num,ya_key');">
                            <input type="radio">
                            Включить
                        </label>

                        <label class="btn btn-default {if($merchants->ya == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons" id="qiwiTrigger">
                        <label class="btn btn-default {if($merchants->qw == 1)} active {/if}"
                               onclick="onQiwiPaymentSystem();">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->qw == 2)} active {/if}"
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->ap == 1)} active {/if}"
                               onclick="change_value('config__bank','ap','1','1');">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->ap == 2)} active {/if}"
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           ...
                           maxlength="255"
                           autocomplete="off"
                           value="{{$merchants->ap_private_key}}"
                           placeholder="Секретный ключ">
                </div>
            ...
            <div class="block">
                ...
                <div class="form-group mb-10">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default {if($merchants->enot == 1)} active {/if}"
                               onclick="change_value('config__bank','enot','1','1');">
                            <input type="radio">
                            Включить
                        </label>
                        <label class="btn btn-default {if($merchants->enot == 2)} active {/if}"
